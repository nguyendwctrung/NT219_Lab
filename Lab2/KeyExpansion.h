...
public:
    ...
    ~KeyExpansion();
    std::vector<uint8_t> KeyExpansion128(const std::vector<uint8_t>& key);
    std::vector<uint8_t> KeyExpansion192(const std::vector<uint8_t>& key);
    std::vector<uint8_t> KeyExpansion256(const std::vector<uint8_t>& key);
};